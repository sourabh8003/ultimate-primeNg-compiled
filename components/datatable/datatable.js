...
TableBody.propDecorators = {
    'toolTipMsg': [{ type: core_1.Input, args: ["pTooltipMsg",] },],
    'toolTipPos': [{ type: core_1.Input, args: ["pTooltipPos",] },],
    'toolTipEve': [{ type: core_1.Input, args: ["pTooltipEve",] },],
    'toolTipPosStyle': [{ type: core_1.Input, args: ["pToolTipPosStyle",] },],
    'toolTipDis': [{ type: core_1.Input, args: ["pTooltipDis",] },],
    'toolTipAppendTo': [{ type: core_1.Input, args: ["pTooltipAppendTo",] },],
    'toolTipStyleClasess': [{ type: core_1.Input, args: ["pTooltipStyleClasess",] },],
    'toolTipEsc': [{ type: core_1.Input, args: ["pTooltipEscape",] },],
